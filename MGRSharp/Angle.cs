...
namespace Worldwind
{
    ...
    public class Angle
    {
        ...
        public static readonly Angle ZERO = Angle.FromDegrees(0);

        /** Represents a right angle of positive 90 degrees */
        public static readonly Angle POS90 = Angle.FromDegrees(90);

        /** Represents a right angle of negative 90 degrees */
        public static readonly Angle NEG90 = Angle.FromDegrees(-90);

        /** Represents an angle of positive 180 degrees */
        public static readonly Angle POS180 = Angle.FromDegrees(180);

        /** Represents an angle of negative 180 degrees */
        public static readonly Angle NEG180 = Angle.FromDegrees(-180);

        /** Represents an angle of positive 360 degrees */
        public static readonly Angle POS360 = Angle.FromDegrees(360);

        /** Represents an angle of negative 360 degrees */
        public static readonly Angle NEG360 = Angle.FromDegrees(-360);

        /** Represents an angle of 1 minute */
        public static readonly Angle MINUTE = Angle.FromDegrees(1.0 / 60.0);

        /** Represents an angle of 1 second */
        public static readonly Angle SECOND = Angle.FromDegrees(1.0 / 3600.0);
        ...
        public static Angle FromDMS(int degrees, int minutes, int seconds)
        {
            ...
            return Angle.FromDegrees(Math.Sign(degrees) * (Math.Abs(degrees) + minutes / 60.0 + seconds / 3600.0));
        }
        ...
        public static Angle FromDMdS(int degrees, double minutes)
        {
            ...
            return Angle.FromDegrees(Math.Sign(degrees) * (Math.Abs(degrees) + minutes / 60.0));
        }
...
*/
        ...
        {
            get { return NormalizeLatitude(this); }
        }

        public Angle NormalizedLongitude
        {
            get { return NormalizeLongitude(this); }
        }
        ...
        public String ToDecimalDegreesString(int digits)
        {
            ...
            return string.Format( "{0:F" + digits + "}", this.degrees );
        }
        ...
        public String ToFormattedDMSString()
        {
            ...
            int m = (int) Math.Floor(temp);
            temp = (temp - m) * 60d;
            double s = Math.Round(temp * 100, MidpointRounding.ToEven) / 100;  // keep two decimals for seconds
