...
public class TMCoord
{
        ...
        double scale)
    {
        ...
        if (originLatitude == null || centralMeridian == null) throw new ArgumentException("Angle Is Null");

        var converter = new TMCoordConverter();
        ...
        var err = converter.SetTransverseMercatorParameters(a.Value, f.Value, originLatitude.radians,
        ...
        double scale)
    {
        ...
        var a = converter.A;
        var f = converter.F;
        var err = converter.SetTransverseMercatorParameters(a, f, originLatitude.radians, centralMeridian.radians,
            falseEasting, falseNorthing, scale);
        if (err == TMCoordConverter.TRANMERC_NO_ERROR)
    ...
    public Angle OriginLatitude => originLatitude;

    public Angle CentralMeridian => centralMeridian;

    public double FalseEasting => falseEasting;

    public double FalseNorthing => falseNorthing;
