...
public class LatLon
{
    public static readonly LatLon ZERO = new(Angle.ZERO, Angle.ZERO);
    ...
    {
        return new LatLon(latitude / Math.PI * 180.0, longitude / Math.PI * 180.0);
    }
    ...
    {
        if (latLon == null) throw new ArgumentException("Lat Lon Is Null");
    ...
    {
        return new double[] { Latitude.radians, Longitude.radians };
    }
    ...
    */
    ...
    {
        if (that == null) throw new ArgumentException("Angle Is Null");
    ...
    */
    ...
    {
        return string.Format("(Lat {0,7:F4}\u0080, Lon {1,7:F4}\u0080",
                                                       ...
                                                       Iterable<? extends LatLon> locations)
    {
        ...
        if (locations == null)
        {
            throw new ArgumentException("Positions List Is Null");
        }
