...
namespace Worldwind
{
    ...
    public class LatLon
    {
        ...
        {
            return new double[] { this.Latitude.degrees, this.Longitude.degrees };
        }
        ...
        {
            return new double[] { this.Latitude.radians, this.Longitude.radians };
        }
        ...
        */
        ...
        override public string ToString()
        {
            return string.Format( "(Lat {0,7:F4}\u0080, Lon {1,7:F4}\u0080",
                                  this.Latitude.Degrees, this.Longitude.Degrees );
        }
