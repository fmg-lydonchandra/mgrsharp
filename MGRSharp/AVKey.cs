...
public static class AVKey
{
    ...
    public static readonly string DATABASE_CONNECTION_POOL_CLASS_NAME =
        "gov.nasa.worldwind.avkey.Database.ConnectionPoolClassName";

    public static readonly string DATABASE_CONNECTION_POOL_FACTORY_CLASS_NAME
        = "gov.nasa.worldwind.avkey.Database.ConnectionPoolFactoryClassName";

    public static readonly string DATABASE_CONNECTION_STRING = "gov.nasa.worldwind.avkey.Database.ConnectionString";
    public static readonly string DATABASE_DRIVER_CLASS_NAME = "gov.nasa.worldwind.avkey.Database.DriverClassName";
    public static readonly string DATABASE_PASSWORD = "gov.nasa.worldwind.avkey.Database.Password";

    public static readonly string DATABASE_POLICY_INITIAL_CONNECTIONS =
        "gov.nasa.worldwind.avkey.DatabasePolicy.InitialConnections";

    public static readonly string DATABASE_POLICY_MAXIMUM_CONNECTIONS =
        "gov.nasa.worldwind.avkey.DatabasePolicy.MaximumConnections";

    public static readonly string DATABASE_POLICY_WAIT_IF_BUSY = "gov.nasa.worldwind.avkey.DatabasePolicy.WaitIfBusy";
    public static readonly string DATABASE_USERNAME = "gov.nasa.worldwind.avkey.Database.Username";
    ...
    public static readonly string DATA_RASTER_READER_FACTORY_CLASS_NAME =
        "gov.nasa.worldwind.avkey.DataRasterReaderFactoryClassName";
    ...
    public static readonly string EARTH_ELEVATION_MODEL_CAPABILITIES =
        "gov.nasa.worldwind.avkey.EarthElevationModelCapabilities";

    public static readonly string EARTH_ELEVATION_MODEL_CLASS_NAME =
        "gov.nasa.worldwind.avkey.EarthElevationModelClassName";

    public static readonly string EARTH_ELEVATION_MODEL_CONFIG_FILE =
        "gov.nasa.worldwind.avkey.EarthElevationModelConfigFile";
    ...
    public static readonly string ELEVATION_EXTREMES_LOOKUP_CACHE_SIZE =
        "gov.nasa.worldwind.avkey.ElevationExtremesLookupCacheSize";
    ...
    public static readonly string HTTP_FILE_UPLOAD_AUTH_TOKEN = "gov.nasa.worldwind.avkey.HTTP.FileUpload.AuthToken";
    public static readonly string HTTP_FILE_UPLOAD_LOCATION = "gov.nasa.worldwind.avkey.HTTP.FileUpload.TempLocation";

    public static readonly string HTTP_FILE_UPLOAD_TEMP_LOCATION =
        "gov.nasa.worldwind.avkey.HTTP.FileUpload.TempLocation";

    public static readonly string HTTP_SERVER_ALLOW_FILE_UPLOAD =
        "gov.nasa.worldwind.avkey.HTTP.Server.Allow.FileUpload";

    public static readonly string HTTP_SERVER_ALLOW_GET = "gov.nasa.worldwind.avkey.HTTP.Server.Allow.GET";
    public static readonly string HTTP_SERVER_ALLOW_POST = "gov.nasa.worldwind.avkey.HTTP.Server.Allow.POST";

    public static readonly string HTTP_SERVER_FILE_UPLOAD_MAX_SIZE =
        "gov.nasa.worldwind.avkey.HTTP.Server.FileUpload.MaxSize";
    ...
    public static readonly string KEYSTORE_PATH = "gov.nasa.worldwind.avkey.KeystorePath";
    public static readonly string KEYSTORE_USER = "gov.nasa.worldwind.avkey.KeystoreUser";
    public static readonly string KEYSTORE_PASSWORD = "gov.nasa.worldwind.avkey.KeystorePassword";
    ...
    public static readonly string MARS_ELEVATION_MODEL_CLASS_NAME =
        "gov.nasa.worldwind.avkey.MarsElevationModelClassName";

    public static readonly string MARS_ELEVATION_MODEL_CONFIG_FILE =
        "gov.nasa.worldwind.avkey.MarsElevationModelConfigFile";
    ...
    /**
         ...
         */
    public static readonly string MIN_ABSENT_TILE_CHECK_INTERVAL =
        "gov.nasa.worldwind.avkey.MinAbsentTileCheckInterval";
    ...
    public static readonly string MOON_ELEVATION_MODEL_CLASS_NAME =
        "gov.nasa.worldwind.avkey.MoonElevationModelClassName";

    public static readonly string MOON_ELEVATION_MODEL_CONFIG_FILE =
        "gov.nasa.worldwind.avkey.MoonElevationModelConfigFile";
    ...
    public static readonly string OVERVIEW_FILE_NAME = "gov.nasa.worldwind.avkey.Overview.FileName";
    ...
    public static readonly string PICKED_OBJECT_PARENT_LAYER_NAME =
        "gov.nasa.worldwind.avkey.PickedObject.ParentLayer.Name";
    ...
    public static readonly string PIXEL_TYPE = DATA_TYPE;
    ...
    public static readonly string RASTER_BAND_ACTUAL_BITS_PER_PIXEL =
        "gov.nasa.worldwind.avkey.RasterBand.ActualBitsPerPixel";
    ...
    public static readonly string RECTANGULAR_TESSELLATOR_MAX_LEVEL =
        "gov.nasa.worldwind.avkey.RectangularTessellatorMaxLevel";
    ...
    public static readonly string RETRIEVE_PROPERTIES_FROM_SERVICE =
        "gov.nasa.worldwind.avkey.RetrievePropertiesFromService";

    public static readonly string RETRIEVAL_QUEUE_SIZE = "gov.nasa.worldwind.avkey.RetrievalQueueSize";

    public static readonly string RETRIEVAL_QUEUE_STALE_REQUEST_LIMIT =
        "gov.nasa.worldwind.avkey.RetrievalStaleRequestLimit";
    ...
    public static readonly string SCALE_HINT_MIN = "gov.nasa.worldwind.avkey.ScaleHintMin";
    public static readonly string SCALE_HINT_MAX = "gov.nasa.worldwind.avkey.ScaleHintMax";
    public static readonly string SCHEDULED_TASK_POOL_SIZE = "gov.nasa.worldwind.avkey.ScheduledTaskPoolSize";

    public static readonly string SCHEDULED_TASK_SERVICE_CLASS_NAME =
        "gov.nasa.worldwind.avkey.ScheduledTaskServiceClassName";
    ...
    public static readonly string SERVER_APP_CLASS_NAME = "gov.nasa.worldwind.avkey.Server.Application.ClassName";
    public static readonly string SERVER_APP_CONFIG_FILE = "gov.nasa.worldwind.avkey.Server.Application.ConfigFile";
    public static readonly string SERVER_APP_CTX = "gov.nasa.worldwind.avkey.Server.Application.Context";
    public static readonly string SERVER_APP_URL = "gov.nasa.worldwind.avkey.Server.Application.URL";

    public static readonly string SERVER_APPLICATION_POOL_CONNECTION_TIMEOUT
        = "gov.nasa.worldwind.avkey.Server.ApplicationPool.ConnectionTimeout";

    public static readonly string SERVER_APPLICATION_POOL_SIZE = "gov.nasa.worldwind.avkey.Server.ApplicationPool.Size";

    public static readonly string SERVER_APPLICATION_POOL_THREAD_TIMEOUT
        = "gov.nasa.worldwind.avkey.Server.ApplicationPool.ThreadTimeout";

    public static readonly string SERVER_CAPABILITIES_ONLINE_RESOURCE =
        "gov.nasa.worldwind.avkey.Server.Capabilities.OnlineResource";

    public static readonly string SERVER_PORT = "gov.nasa.worldwind.avkey.Server.Port";
    public static readonly string SERVER_REDIRECT_TO = "gov.nasa.worldwind.avkey.Server.RedirectTo";
    public static readonly string SERVER_TEMP_DIRECTORY = "gov.nasa.worldwind.avkey.Server.TempDirectory";
    ...
    public static readonly string SERVER_CERTIFICATE = "gov.nasa.worldwind.avkey.Server.Certificate";
    ...
    public static readonly string SERVER_VIRTUAL_DIRECTORY = "gov.nasa.worldwind.avkey.Server.VirtualDirectory";
    ...
    public static readonly string
        STEREO_MODE = "gov.nasa.worldwind.stereo.mode"; // lowercase to match Java property convention
    ...
    public static readonly string TILED_RASTER_PRODUCER_CACHE_SIZE =
        "gov.nasa.worldwind.avkey.TiledRasterProducerCacheSize";
    ...
    public static readonly string TILED_RASTER_PRODUCER_LIMIT_MAX_LEVEL =
        "gov.nasa.worldwind.avkey.TiledRasterProducer.LimitMaxLevel";
    ...
    public static readonly string CAPABILITIES_TEMPLATE_PATH = "gov.nasa.worldwind.avkey.CapabilitiesTemplatePath";
    ...
    public static readonly string WORLD_WIND_DOT_NET_PERMANENT_DIRECTORY =
        "gov.nasa.worldwind.avkey.WorldWindDotNetPermanentDirectory";
